    ...
    <div class="showbox" v-if="show == true">
      <div v-for=" item in navigation" class=" itemBox flex-d " :key="item.id">
       <div class="itemL flex al-center ju-between">  
         {{item.label}}
         <img ref="xialaImg" src="../../img//home/xiala.png" :style="{ transform:transform,transition: 'all 2s'}" @click="xiala" v-if="item.children" class="xialaImg" alt="">
       </div>
...
export default {
  ...
  methods: {
    xiala(){
       ...
       console.log( this.$refs.xialaImg)
    }
  },
  mounted() {},
  watch: {},
