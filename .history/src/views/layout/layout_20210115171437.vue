<template>
  <div>
    ...
    <div class="showbox" v-if="show == true">
      <div v-for=" item in navigation" class=" itemBox flex al-center" :key="item.id">
       <div class="itemL flex al-center ju-between"> {{item.label}}
         <img src="../../img//home/xiala.png" v-if="item.children" class="xialaImg" alt="">
       </div>
      </div>
    </div>
